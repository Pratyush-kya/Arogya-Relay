...
export const CATALOG: Catalog = {
  ...
  // ── Overview (Tier 3) ──────────────────────────────────────────────────
  "overview.greeting": { tier: "tier3", en: "Good morning, Sara.", hi: "सुप्रभात, सारा।", or: "ଶୁଭ ସକାଳ, ସାରା।", bn: "সুপ্রভাত, সারা।", as: "শুভ সকাল, ছাৰা।", te: "శుభోదయం, సారా.", mr: "शुभ सकाळ, सारा.", sat: "ᱥᱩᱵ ᱥᱟᱜᱩᱱ, ᱥᱟᱨᱟᱹ" },
